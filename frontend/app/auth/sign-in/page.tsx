  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.email.trim() || !formData.password) {
      setErrors([
        {
          field: "general",
          message: t.emailPasswordRequired,
        },
      ]);
      return;
    }
    ...
    <div className="min-h-screen flex items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 fade-in">
        ...
        <div className="glass-strong rounded-3xl p-8 card-3d">
          ...
          {/* Sign-up Link */}
          <div className="mt-8 text-center text-fade-up text-fade-up-delay-3">
            <p className="text-sm font-medium">
              <span className="text-purple-700 dark:text-purple-300">{t.dontHaveAccount}</span>{" "}
              <Link
                href="/auth/sign-up"
